...
- Using Package Manager Window
    ...
    - Copy paste the [repository link](https://github.com/ErikRikoo/com.rikoo.shape-formulas.git)
    - Press enter
...
```json
{
  "dependancies": {
    ...
    "com.rikoo.editor-utilities": "https://github.com/ErikRikoo/com.rikoo.shape-formulas.git",
    ...
  }
}
```
...
```json
{
  "dependencies": {
    ...
    "com.rikoo.shape-formulas": {
      "version": "https://github.com/ErikRikoo/com.rikoo.shape-formulas.git",
      "depth": 0,
      "source": "git",
      "dependencies": {},
...
```
- Remove the _"com.rikoo.shape-formulas"_ and save the file
- Get back to Unity
- Let him refresh
